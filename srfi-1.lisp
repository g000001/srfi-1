...
(declaim (inline first second third fourth fifth sixth seventh
                 eighth ninth tenth))
(define first  #'car)
(define second #'cadr)
(define third  #'caddr)
...
(define (partition! pred lis)
  ...
  (if (null-list? lis) (values lis lis)
      ...
      (labels ((scan-in (in-prev out-prev lis)
